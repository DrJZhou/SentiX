            ...
            for i_batch, sample_batched in enumerate(train_data_loader):
                ...
                if i_batch % int(batch_num/40) == 0 and i_batch != 0:
                    ...
                    if not os.path.exists('state_dict'):
                        os.mkdir('state_dict')
                    path = 'state_dict/{0}_{1}_val_f1_{2}_meanf1_{3}_Rating_Mask'.format(self.opt.model_name,
                                                                                         self.opt.dataset,
                                                                                         round(val_f1[-1], 4),
                    ...
                    path_bert = 'state_dict/bert_{0}_{1}_val_f1_{2}_meanf1_{3}_Rating_Mask'.format(self.opt.model_name,
                                                                                                   self.opt.dataset,
                                                                                                   round(val_f1[-1], 4),
                                                                                                   round(
                                                                                                       np.mean(val_f1),
