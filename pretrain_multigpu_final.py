            ...
            for i_batch, sample_batched in enumerate(train_data_loader):
                ...
                if global_step % int(batch_num/20) == 0:
                    ...
                    if not os.path.exists('state_dict'):
                        os.mkdir('state_dict')
                    path = 'state_dict/{0}_{1}_val_acc_{2}_{3}_Rating_Mask'.format(self.opt.model_name,
                                                                                         self.opt.dataset,
                                                                                         round(val_acc[0], 4),
                                                                                         round(val_acc[1], 4))
                    try:
                    ...
                    path_bert = 'state_dict/bert_{0}_{1}_val_acc_{2}_{3}_Rating_Mask'.format(self.opt.model_name,
                                                                                                   self.opt.dataset,
                                                                                                   round(val_acc[0], 4),
                                                                                                   round(val_acc[1], 4))
